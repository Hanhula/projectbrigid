...
export class OrganisationDisplay extends ArticleDisplay {
  ...
  constructor(organisation: Organisation) {
    ...
    this.body = {
      ...
      publicAgenda: organisation.publicAgenda
        ? organisation.publicAgenda
        : null,
      ...
      demographyAndPopulation: organisation.demographics
      ...
      grantedDivinePowers: organisation.divinepowers
        ? organisation.divinepowers
        : null,
      politicalInfluenceAndIntrigue: organisation.intrigue
    ...
    this.sidebar = {
      ...
      sidepanelcontenttop: organisation.sidepanelcontenttop
        ? organisation.sidepanelcontenttop
        : null,
      foundingDate: organisation.foundingDate
        ? organisation.foundingDate
        : null,
      dissolutionDate: organisation.dissolutionDate
        ? organisation.dissolutionDate
        : null,
      type: organisation.type ? organisation.type.title : null,
      capital: organisation.capital
        ? this.formatMention(organisation.capital)
        : null,
      alternativeNames: organisation.alternativeNames
        ? organisation.alternativeNames
        : null,
      predecessorOrganisation: organisation.predecessors
        ? this.formatMentions(organisation.predecessors)
        : null,
      successorOrganisation: organisation.successors
        ? this.formatMentions(organisation.successors)
        : null,
      formationType: organisation.formation
        ? this.formatMention(organisation.formation)
        : null,
      trainingLevel: organisation.trainingLevel
      ...
      leader: organisation.leader
        ? this.formatMention(organisation.leader)
        : null,
      rulingOrganisation: organisation.rulingorganization
        ? this.formatMention(organisation.rulingorganization)
        : null,
      leaderTitle: organisation.leadertitle
        ? this.formatMention(organisation.leadertitle)
        : null,
      familyLeader: organisation.familyleader
        ? this.formatMention(organisation.familyleader)
        : null,
      headOfState: organisation.headofstate
        ? this.formatMention(organisation.headofstate)
        : null,
      headOfGovernment: organisation.headofgovernment
        ? this.formatMention(organisation.headofgovernment)
        : null,
      governmentSystem: organisation.governmentsystem
        ? organisation.governmentsystem
        : null,
      powerStructure: organisation.powerstructure
        ? organisation.powerstructure
        : null,
      economicSystem: organisation.economicsystem
      ...
      legislativeBody: organisation.legislative
        ? organisation.legislative
        : null,
      executiveBody: organisation.executive ? organisation.executive : null,
      officialStateReligion: organisation.statereligion
        ? this.formatMention(organisation.statereligion)
        : null,
      parentOrganisation: organisation.parent
        ? this.formatMention(organisation.parent)
        : null,
      deities: organisation.deities
        ? this.formatMentions(organisation.deities)
        : null,
      location: organisation.geographicLocation
        ? this.formatMention(organisation.geographicLocation)
        : null,
      officialLanguages: organisation.languages
        ? this.formatMentions(organisation.languages)
        : null,
      neighboringNations: organisation.neighbors
        ? this.formatMentions(organisation.neighbors)
        : null,
      relatedSpecies: organisation.relatedSpecies
        ? this.formatMentions(organisation.relatedSpecies)
        : null,
      relatedEthnicities: organisation.ethnicities
        ? this.formatMentions(organisation.ethnicities)
        : null,
      sidepanelcontent: organisation.sidepanelcontent
        ? organisation.sidepanelcontent
        : null,
      sidebarcontentbottom: organisation.sidebarcontentbottom
        ? organisation.sidebarcontentbottom
        : null,
    };
  }
}
