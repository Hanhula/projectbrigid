...
export class ProfessionDisplay extends ArticleDisplay {
  ...
  constructor(profession: Profession) {
    ...
    this.body = {
      ...
      qualifications: profession.qualifications
    ...
    this.sidebar = {
      sidebarcontent: profession.sidebarcontent
        ? profession.sidebarcontent
        : null,
      sidepanelcontenttop: profession.sidepanelcontenttop
        ? profession.sidepanelcontenttop
        : null,
      alternativeNames: profession.alternativeNames
        ? profession.alternativeNames
        : null,
      ...
      famousInTheField: profession.holders
        ? this.formatMentions(profession.holders)
        : null,
      otherAssociatedProfessions: profession.relatedprofessions
        ? this.formatMentions(profession.relatedprofessions)
        : null,
      relatedLocations: profession.relatedlocations
        ? this.formatMentions(profession.relatedlocations)
        : null,
      usedBy: profession.relatedorganizations
        ? this.formatMentions(profession.relatedorganizations)
        : null,
      ranksAndTitles: profession.relatedranks
        ? this.formatMentions(profession.relatedranks)
        : null,
      relatedVehicles: profession.relatedvehicles
        ? this.formatMentions(profession.relatedvehicles)
        : null,
      relatedTechnologies: profession.relatedtechnologies
        ? this.formatMentions(profession.relatedtechnologies)
        : null,
      relatedMaterials: profession.relatedmaterials
        ? this.formatMentions(profession.relatedmaterials)
        : null,
      sidepanelcontent: profession.sidepanelcontent
        ? profession.sidepanelcontent
        : null,
      sidebarcontentbottom: profession.sidebarcontentbottom
        ? profession.sidebarcontentbottom
        : null,
    };
  }
}
